<template>
  <div class="content_container">
    <div v-for="item in colorlist" :key="item.id" :style="{ backgroundColor: item.color }" class="color_list"
         @click="onclickItem(item.color)">
      <img alt="" class="Image" src="/src/assets/headTop/wyyIcon.png">
      <div class="bottom_name">{{ item.name }}</div>
      <div v-if="activeTab === item.color" class="sure">
        <img alt="" src="/src/assets/headTop/sureselect.png">
      </div>
    </div>
  </div>
</template>
